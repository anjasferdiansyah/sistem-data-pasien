            ...
            <div class="bg-white rounded-2xl border border-slate-200 overflow-hidden">
                ...
                <div class="p-6 border-b border-slate-100" style="background: linear-gradient(135deg, #f8fafc, #f1f5f9);">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h3 class="text-base font-bold text-slate-800">Edit Data Pasien</h3>
                            <p class="text-xs text-slate-500">Perbarui informasi pasien yang ada</p>
                        </div>
                    </div>
                </div>

                <!-- Form Body -->
                <form method="POST" action="{{ route('data-pasien.update', $dataPasien->id) }}" class="p-6 space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="nama" name="nama" value="{{ old('nama', $dataPasien->nama) }}"
                        ...
                        <div>
                            ...
                            <input type="text" id="nik" name="nik" value="{{ old('nik', $dataPasien->nik) }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="date" id="tanggal_lahir" name="tanggal_lahir"
                                value="{{ old('tanggal_lahir', $dataPasien->tanggal_lahir ? $dataPasien->tanggal_lahir->format('Y-m-d') : '') }}"
                                required
                        ...
                        <div>
                            ...
                            <select id="jenis_kelamin" name="jenis_kelamin" required
                                ...
                                <option value="L" {{ old('jenis_kelamin', $dataPasien->jenis_kelamin) == 'L' ? 'selected' : '' }}>Laki-laki</option>
                                <option value="P" {{ old('jenis_kelamin', $dataPasien->jenis_kelamin) == 'P' ? 'selected' : '' }}>Perempuan</option>
                            </select>
                            @error('jenis_kelamin')
                                <p class="mt-1.5 text-xs text-red-500 flex items-center gap-1">{{ $message }}</p>
                            @enderror
                    ...
                    <div>
                        ...
                        <textarea id="alamat" name="alamat" placeholder="Masukkan alamat lengkap pasien" rows="3" required
                            class="form-input {{ $errors->has('alamat') ? '!border-red-400 !shadow-red-100' : '' }}">{{ old('alamat', $dataPasien->alamat) }}</textarea>
                        @error('alamat')
                            <p class="mt-1.5 text-xs text-red-500 flex items-center gap-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="no_telepon" name="no_telepon"
                                value="{{ old('no_telepon', $dataPasien->no_telepon) }}" placeholder="081234567890" required
                        ...
                        <div>
                            ...
                            <input type="email" id="email" name="email" value="{{ old('email', $dataPasien->email) }}"
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <select id="golongan_darah" name="golongan_darah"
                                ...
                                <option value="A" {{ old('golongan_darah', $dataPasien->golongan_darah) == 'A' ? 'selected' : '' }}>A</option>
                                <option value="B" {{ old('golongan_darah', $dataPasien->golongan_darah) == 'B' ? 'selected' : '' }}>B</option>
                                <option value="AB" {{ old('golongan_darah', $dataPasien->golongan_darah) == 'AB' ? 'selected' : '' }}>AB</option>
                                <option value="O" {{ old('golongan_darah', $dataPasien->golongan_darah) == 'O' ? 'selected' : '' }}>O</option>
                            </select>
                    ...
                    <div>
                        ...
                        <textarea id="riwayat_penyakit" name="riwayat_penyakit"
                            ...
                            class="form-input {{ $errors->has('riwayat_penyakit') ? '!border-red-400 !shadow-red-100' : '' }}">{{ old('riwayat_penyakit', $dataPasien->riwayat_penyakit) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="alergi" name="alergi" placeholder="Tuliskan alergi yang dimiliki pasien (opsional)"
                            rows="3"
                            class="form-input {{ $errors->has('alergi') ? '!border-red-400 !shadow-red-100' : '' }}">{{ old('alergi', $dataPasien->alergi) }}</textarea>
                        @error('alergi')
                            <p class="mt-1.5 text-xs text-red-500 flex items-center gap-1">{{ $message }}</p>
                        @enderror
                    </div>
